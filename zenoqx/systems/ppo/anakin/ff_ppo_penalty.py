...
from zenoqx.utils.loss import clipped_value_loss, ppo_penalty_loss
        ...
        def _update_epoch(update_state: Tuple, _: Any) -> Tuple:
            ...
            def _update_minibatch(train_state: Tuple, batch_info: Tuple) -> Tuple:
                ...
                def _actor_loss_fn(
                    ...
                    behaviour_policy = jax.vmap(behaviour_actor_model)(traj_batch.obs)
                ...
                return (new_model, new_opt_state), loss_info
