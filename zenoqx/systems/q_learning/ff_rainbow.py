...
def get_warmup_fn(
    ...
    def warmup(
        ...
        def _env_step(
            ...
            actor_policy, _, _ = q_model.online(last_timestep.observation, noise_key)
...
def get_learner_fn(
    ...
    def _update_step(
        ...
        def _env_step(
            ...
            """Step the environment."""
            q_model, opt_states, buffer_state, key, env_state, last_timestep = learner_state
            ...
            learner_state = OffPolicyLearnerState(
                q_model, opt_states, buffer_state, key, env_state, timestep
            )
        ...
        def _update_epoch(update_state: Tuple, _: Any) -> Tuple:
            ...
            def _q_loss_fn(
                ...
                _, q_logits_tm1, q_atoms_tm1 = q_model(transitions.obs, noise_key_tm1)

                _, q_logits_t, q_atoms_t = target_q_model(transitions.next_obs, noise_key_t)
                q_t_selector_dist, _, _ = q_model(transitions.next_obs, noise_key_select)
            ...
            q_new_online_params = optax.apply_updates(models.online, q_updates)
            # Target network polyak update.
            new_target_q_models = optax.incremental_update(
                q_new_online_params, models.target, config.system.tau
            )
            q_new_models = OnlineAndTarget(q_new_online_params, new_target_q_models)
...
def learner_setup(
    env: Environment, key: chex.Array, config: DictConfig
...
def run_experiment(_config: DictConfig) -> float:
    ...
    # Setup learner.
    learn, eval_q_network, learner_state = learner_setup(env, key_l, config)
