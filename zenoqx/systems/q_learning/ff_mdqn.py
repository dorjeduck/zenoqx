...
from zenoqx.utils.loss import munchausen_q_learning
    ...
    def _update_step(
        ...
        def _update_epoch(update_state: Tuple, _: Any) -> Tuple:
            ...
            def _q_loss_fn(
                ...
                q_tm1_target = q_model(transitions.obs).distributions.preferences
                q_t_target = target_q_model(transitions.next_obs).distributions.preferences
