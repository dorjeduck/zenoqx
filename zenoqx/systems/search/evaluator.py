...
from zenoqx.base_types import EvalFn, EvalState, EvaluationOutput
from zenoqx.systems.search.search_types import RootFnApply, SearchApply, MZModels, ActorCriticModels
from zenoqx.utils.jax_utils import unreplicate_batch_dim
...
def get_search_evaluator_fn(
    ...
    def eval_one_episode(model: eqx.Module, init_eval_state: EvalState) -> Dict:
        ...
        def _env_step(eval_state: EvalState) -> EvalState:
            ...
            root = root_fn(model, obs, model_env_state, root_key)
            search_output = search_apply_fn(model, policy_key, root)
    ...
    def evaluator_fn(trained_model: eqx.Module, key: chex.PRNGKey) -> EvaluationOutput[EvalState]:
        """Evaluator function."""
